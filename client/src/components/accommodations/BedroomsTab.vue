...
<template>
  <div>
    <div class="flex items-center justify-between mb-4">
      ...
      <button @click="showForm = !showForm" class="text-sm text-indigo-600 hover:text-indigo-700 font-medium">
    ...
    <div v-if="accommodation.bedrooms?.length" class="grid grid-cols-2 gap-4">
      <div v-for="bedroom in accommodation.bedrooms" :key="bedroom.bedroom_id" class="bg-gray-50 rounded-lg p-4">
        <div class="flex items-center justify-between mb-3">
          ...
          <div class="flex items-center gap-2">
            ...
            <button @click="deleteBedroom(bedroom.bedroom_id)" class="text-red-400 hover:text-red-600 text-xs">Remove</button>
          </div>
        </div>
